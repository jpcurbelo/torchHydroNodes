...
def load_results_path(results_folder: Path, periods: list):
    ...
    if results_folder.exists():
        ...
        if model_metrics_path.exists() and 'julia' not in str(results_folder) and 'neuralhydrology' not in str(results_folder):
        ...
        if 'julia' not in str(results_folder) and 'neuralhydrology' not in str(results_folder):
