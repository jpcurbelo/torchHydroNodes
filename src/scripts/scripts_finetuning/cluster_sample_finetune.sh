...
# #SBATCH --job-name=fract01_euler1d_64x5
# #SBATCH --job-name=fract01_euler1d_64x3
# #SBATCH --job-name=fract02_euler1d
# #SBATCH --job-name=fract02_euler05d
# #SBATCH --job-name=finetune_euler02d
# #SBATCH --job-name=fract02_rk4_1d
# #SBATCH --job-name=fract01_rk4_05d
# #SBATCH --job-name=fract02_rk4_05d
# #SBATCH --job-name=fract02_rk23tol33
# #SBATCH --job-name=fract01_rk23tol46
#SBATCH --job-name=fract02_rk23tol69
